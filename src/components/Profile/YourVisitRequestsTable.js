...
function YourVisitRequestsTable() {
      ...
      <table className="table-design">
          <thead className="table-head">
            <tr className="table-row">
              <th className="table-h">Visit ID</th>
              <th className="table-h">House ID</th>
              <th className="table-h">House Name</th>
              <th className="table-h">Visit Request Status</th>
            </tr>
          </thead>
...
export default YourVisitRequestsTable;
