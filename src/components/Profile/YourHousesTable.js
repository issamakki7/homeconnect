        ...
        <table className="table-design">
          <thead className="table-head">
            <tr className="table-row">
              ...
              <th className="table-h">Price Requested</th>
              <th className="table-h">Bids Received</th>
              <th className="table-h">Visit Requests Received</th>
...
export default YourHousesTable;
